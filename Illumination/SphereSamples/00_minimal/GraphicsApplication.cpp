...
bool VulkanGraphicsApplication::Initialize(const char* appName)
{
	...
	// on sait que le moniteur applique une conversion implicit de sRGB vers lineaire
	...
	// VKFORMAT***_SRGB -> conversion automatique lineaire vers sRGB
	// attention ce changement ne concerne que la swapchain ici
	...
	//We can get the render capabilities of a render surface
	...
	///And then request what can work or not depending of the device capability
